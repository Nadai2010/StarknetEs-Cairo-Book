...
- [Cómo empezar](ch01-00-getting-started.md)
  ...
  - [Hola, Scarb!](ch01-03-hello-scarb.md)

## Conceptos comunes de programación

- [Conceptos comunes de programación](ch02-00-common-programming-concepts.md)
  - [Variables y mutabilidad](ch02-01-variables-and-mutability.md)
...
- [ Uso de estructuras para estructurar datos relacionados](ch04-00-using-structs-to-structure-related-data.md)
  - [Definición e instanciación de estructuras](ch04-01-defining-and-instantiating-structs.md)
  - [Un programa de ejemplo usando estructuras](ch04-02-an-example-program-using-structs.md)
  - [Sintaxis de métodos](ch04-03-method-syntax.md)

## Enums y Concordancia de Patrones

- [Enums y Concordancia de Patrones](ch05-00-enums-and-pattern-matching.md)
  - [Enums](ch05-01-enums.md)
  - [La construcción del flujo de control de coincidencias](ch05-02-the-match-control-flow-construct.md)

## Gestionando Proyectos Cairo con Paquetes, Crates y Módulos

- [Gestionando Proyectos Cairo con Paquetes, Crates y Módulos](ch06-00-managing-cairo-projects-with-packages-crates-and-modules.md)

  - [Paquetes y Crates](ch06-01-packages-and-crates.md)

  - [Definición de módulos para controlar el alcance](ch06-02-defining-modules-to-control-scope.md)
  - [Rutas para referirse a un elemento en el Arbol de Módulos](ch06-03-paths-for-referring-to-an-item-in-the-module-tree.md)
